...
namespace Microsoft.MixedReality.Toolkit.SpatialManipulation
{
    ...
    public class ObjectManipulator : StatefulInteractable
    {
        ...
        private List<MixedRealityPose> interactionPoints = new List<MixedRealityPose>();

        // Reusable list for fetching attachPoints from interactors.
        private List<MixedRealityPose> attachPoints = new List<MixedRealityPose>();

        // Reusable list for fetching grabPoints from interactors.
        private List<MixedRealityPose> grabPoints = new List<MixedRealityPose>();
