...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class MRTKRayInteractor : XRRayInteractor, IRayInteractor, IHandedInteractor, IVariableSelectInteractor
    {
        ...
        public override void ProcessInteractor(XRInteractionUpdateOrder.UpdatePhase updatePhase)
        {
            ...
            using (ProcessInteractorPerfMarker.Auto())
            {
                if (updatePhase == XRInteractionUpdateOrder.UpdatePhase.Dynamic)
                {
                    ...
                    if (hasSelection)
                    {
                        float distanceRatio = PoseUtilities.GetDistanceToBody(new MixedRealityPose(transform.position, transform.rotation)) / refDistance;
        ...
        protected override void OnSelectEntering(SelectEnterEventArgs args)
        {
            ...
            refDistance = PoseUtilities.GetDistanceToBody(new MixedRealityPose(transform.position, transform.rotation));
        }
