...
namespace Microsoft.MixedReality.Toolkit.Input
{
    ...
    public class GazePinchInteractor : XRBaseControllerInteractor, IGazePinchInteractor, IHandedInteractor
    {
        ...
        /// </summary>
        public MixedRealityPose PinchPose => handController.PinchSelectPose;
        ...
        private void ComputeAttachTransform(IXRSelectInteractable interactable)
        {
            ...
            float distanceRatio = PoseUtilities.GetDistanceToBody(new MixedRealityPose(transform.position, transform.rotation)) / bodyDistanceOnSelect;
        ...
        private void ResetManipLogic(IXRSelectInteractable interactable)
        {
            ...
            bodyDistanceOnSelect = PoseUtilities.GetDistanceToBody(new MixedRealityPose(transform.position, transform.rotation));
        }

        /// <summary>
        /// Computes the geometric centroid between all PinchPoses of participtaing GazePinchInteractors.
        /// </summary>
        private MixedRealityPose GetPinchCentroid(IXRSelectInteractable interactable)
        {
