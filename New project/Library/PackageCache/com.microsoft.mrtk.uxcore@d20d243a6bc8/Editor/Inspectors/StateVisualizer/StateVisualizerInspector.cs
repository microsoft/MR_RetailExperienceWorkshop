...
namespace Microsoft.MixedReality.Toolkit.Editor
{
    ...
    public class StateVisualizerInspector : UnityEditor.Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (interactable != null && interactable.objectReferenceValue != null)
            {
                RenderStates();
            }
        ...
        private void RenderStates()
        {
            ...
            foreach (var kvp in stateContainers)
            {
                ...
                if (stateName == "Toggle" && (interactable.objectReferenceValue as StatefulInteractable).ToggleMode == StatefulInteractable.ToggleType.Button)
                {
                    continue;
                }
