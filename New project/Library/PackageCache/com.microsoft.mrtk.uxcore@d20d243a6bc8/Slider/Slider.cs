...
namespace Microsoft.MixedReality.Toolkit.UX
{
    ...
    public class Slider : StatefulInteractable, ISnapInteractable
    {
        ...
        {
            get { return snapToPosition && trackCollider != null; }
            set 
            { 
        ...
        {
            get { return SliderEnd.position - SliderStart.position; }
        }
