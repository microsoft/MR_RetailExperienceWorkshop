...
";
        ...
        /// </summary>
        public static void GenerateCanvasMaterialAnimator(Shader shader, bool saveToParentDirectory = false)
        {
        ...
        /// <summary>
        /// Menu item to call GenerateCanvasMaterialAnimator for each shader within Assets/Runtime/Shaders.
        /// </summary>
        ...
        private static void CanvasMaterialAnimatorsGenerateAll()
        {
            ...
            foreach (string path in paths)
            {
                ...
                if (shader != null)
                {
                    GenerateCanvasMaterialAnimator(shader, true);
                }
            }
        }
